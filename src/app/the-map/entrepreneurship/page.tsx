      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="border border-slate-700 rounded-xl p-6 bg-slate-900/40">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            <li className="flex gap-2 flex-wrap"><span className="text-blue-300 flex-shrink-0">&middot;</span><a href="https://beyondtheuniform.org/career-interviews" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline">Beyond the Uniform &mdash; founder interviews</a><span className="text-slate-400">Justin Nassiri has interviewed dozens of vet founders, including failures and pivots.</span></li>
            <li className="flex gap-2 flex-wrap"><span className="text-blue-300 flex-shrink-0">&middot;</span><a href="https://hiversandstrivers.com/team-members/" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline">Hivers and Strivers portfolio &amp; team</a><span className="text-slate-400">Real names, real companies, real outcomes — both wins and losses.</span></li>
