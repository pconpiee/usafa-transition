      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section className="border border-slate-700 rounded-xl p-6 bg-slate-900/40">
          ...
          <ul className="space-y-2 text-sm text-slate-300">
            <li className="flex gap-2 flex-wrap"><span className="text-blue-300 flex-shrink-0">&middot;</span><a href="https://beyondtheuniform.org/career-interviews" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline">Beyond the Uniform</a><span className="text-slate-400">Justin Nassiri&rsquo;s interviews include vet teachers, ministers, and nonprofit EDs.</span></li>
            <li className="flex gap-2 flex-wrap"><span className="text-blue-300 flex-shrink-0">&middot;</span><a href="https://www.teachforamerica.org/stories/topic/veterans" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline">TFA veterans stories</a><span className="text-slate-400">Named profiles of vet TFA corps members across years and regions.</span></li>
            <li className="flex gap-2 flex-wrap"><span className="text-blue-300 flex-shrink-0">&middot;</span><a href="https://missioncontinues.org/our-story/fellow-stories/" target="_blank" rel="noopener noreferrer" className="text-blue-300 hover:text-blue-200 underline">Mission Continues fellow stories</a><span className="text-slate-400">Real fellow profiles &mdash; what nonprofit work is like inside.</span></li>
          </ul>
        </section>
